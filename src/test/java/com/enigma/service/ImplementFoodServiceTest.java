...
public class ImplementFoodServiceTest {
    ...
    public void should_return_all_data_when_getAllFood(){
        FoodEntities foodEntities1 = new FoodEntities("Kangkung", "Food", new BigDecimal(20000), 10);
        FoodEntities foodEntities2 = new FoodEntities("Sayur Asem", "Food", new BigDecimal(15000), 1);
    ...
    public void should_return_data_food_with_pagination(){
        FoodEntities foodEntities1 = new FoodEntities("Kangkung", "Food", new BigDecimal(20000), 10);
        FoodEntities foodEntities2 = new FoodEntities("Sayur Asem", "Food", new BigDecimal(15000), 10);
